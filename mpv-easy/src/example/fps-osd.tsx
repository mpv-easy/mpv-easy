...
import { OsdOverlay, addKeyBinding, getAssScale, getOsdSize, setPropertyBool } from '@mpv-easy/tool';
...
const ovlList = Array(count).fill(0).map(() => ({
  x: 0, y: 0, ovl: new OsdOverlay({
    hidden: false,
    computeBounds: false,
  })
}))
