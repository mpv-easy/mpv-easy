mpv-easy-scripts is a series of js scripts implemented using mpv-easy, you only need to download a single js file and add a shortcut key in `input.conf` to install it.
